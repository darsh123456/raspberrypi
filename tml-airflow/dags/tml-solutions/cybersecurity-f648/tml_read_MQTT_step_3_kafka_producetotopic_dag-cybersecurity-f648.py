...
default_args = {
  ...
  'mqtt_broker' : 'dbaeaa7ac9d04db5a2b9227f1031f1b5.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_cybersecurity-f648", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_cybersecurity-f648"], schedule=None,catchup=False)
